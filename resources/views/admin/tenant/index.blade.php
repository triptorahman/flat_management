            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="mb-6 flex justify-between items-center">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">Manage all tenants and their information.</p>
                    </div>
                    <div class="text-sm text-gray-500">
                        Total: {{ $tenants->total() }} {{ Str::plural('tenant', $tenants->total()) }}
                    </div>
                </div>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex space-x-2">
                                                    <a href="{{ route('tenants.show', $tenant->id) }}" class="text-indigo-600 hover:text-indigo-900" title="View">
                                                    ...
                                                    <button type="button" onclick="confirmDelete({{ $tenant->id }})" class="text-red-600 hover:text-red-900" title="Delete">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Delete Tenant</h3>
                            <div class="mt-2">
