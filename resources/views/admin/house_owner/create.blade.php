<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Add New House Owner & Building') }}
            </h2>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form method="POST" action="{{ route('house-owners.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <div class="max-w-xl">
                        ...
                        <p class="mt-1 text-sm text-gray-600">Enter the personal details of the house owner.</p>
                ...
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <div class="max-w-xl">
                        ...
                        <p class="mt-1 text-sm text-gray-600">Enter the details of the building owned by this house owner.</p>
                        ...
                        <div class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="building_address" 
                                          ...
                                          rows="3"
                                          required
                                          class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('building_address') border-red-300 @enderror">{{ old('building_address') }}</textarea>
