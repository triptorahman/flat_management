...
<div class="flex justify-between items-center">
    <div>
        ...
        <p class="text-sm text-gray-600 mt-1">Create a new flat in {{ $building->name }}</p>
    </div>
    <div>
...
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <!-- Flat Creation Form -->
        <form method="POST" action="{{ route('house-owner.flats.store') }}">
            @csrf
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600">Enter the basic information for the new flat</p>
                </div>
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-1">
                            ...
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">Enter a unique flat number for this building</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600">Optional details about the flat owner/resident (can be added later)</p>
                </div>
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Owner Name -->
